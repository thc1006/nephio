...
// TestUnusableHostsAreRefused covers the shapes a second parser reads
...
func TestUnusableHostsAreRefused(t *testing.T) {
...
// TestAPIServerOrigin pins the helper on its own terms. Its callers happen to
...
func TestAPIServerOrigin(t *testing.T) {
	same := [][2]string{
